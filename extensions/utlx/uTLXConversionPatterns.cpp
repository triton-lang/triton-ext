/// uTLX plugin: ConvertTritonToTritonGPU (plugin-local copy)
///
...
void registerUTLXConversionPass() {
...
void addUTLXInsertAndPropagatePass(mlir::PassManager *pm,
                                   const std::vector<std::string> &) {
  pm->addPass(createTLXInsertAndPropagateLayoutPass());
}

void registerUTLXInsertAndPropagatePass() {
  mlir::registerPass([]() -> std::unique_ptr<mlir::Pass> {
