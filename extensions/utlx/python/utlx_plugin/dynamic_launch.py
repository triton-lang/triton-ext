...
@tl.builtin
def clc_create_context(num_consumers, num_stages=1, _semantic=None) -> tlx.CLCPipelineContext:
...
@tl.builtin
def clc_producer(context, p_producer=None, multi_ctas=False, k=0, _semantic=None):
...
@tl.builtin
def clc_consumer(context, p_consumer=None, multi_ctas=False, k=0, _semantic=None):
