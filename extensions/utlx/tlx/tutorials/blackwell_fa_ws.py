    ...
    with tlx.async_tasks():
        ...
        with tlx.async_task("default"):
            ...
            for cid in tl.range(0,
                ...
                # to flip the phase.
                tlx.barrier_wait(acc_empties[buf_idx + cid * NUM_BUFFERS_QK],
                                 phase)
        ...
        with tlx.async_task(num_warps=4,
            ...
            for _ in tl.range(lo, hi, BLOCK_N):
                qk_bufIdx, qk_phase = _get_bufidx_phase(
                ...
                # Use alpha[0] for cid=0, and alpha[HEAD_DIM * NUM_BUFFERS_QK] for cid=1
                tlx.local_store(alpha_tiles[cid * HEAD_DIM * NUM_BUFFERS_QK],
                                alpha[:, None])
                ...
                for cid in tl.range(0,
                    ...
                    if cid == NUM_MMA_GROUPS - 1:
                        tlx.async_dot(
                            ...
                            use_acc=False,
                            mBarriers=[
                                qk_fulls[qk_bufIdx_2], kv_empties[k_bufIdx]
                            ],
                        )
                    else:
                        tlx.async_dot(
                ...
                for cid in tl.range(0,
                    ...
                    if cid == NUM_MMA_GROUPS - 1:
                        tlx.async_dot(
                            ...
                            use_acc=i > 0,
                            mBarriers=[
                                acc_empties[qk_bufIdx_2], kv_empties[v_bufIdx]
                            ],
                        )
                    else:
                        tlx.async_dot(
