...
void createTMemSubslice(TritonOpBuilder &, std::vector<mlir::Value> &);
void createTMemLoad(TritonOpBuilder &, std::vector<mlir::Value> &);
void createTMemStore(TritonOpBuilder &, std::vector<mlir::Value> &);
void createMemDescReinterpret(TritonOpBuilder &, std::vector<mlir::Value> &);
