...
#define TRITON_EXT_PASS_REGISTER_FUNC CONCAT(registerTritonExt, TRITON_EXT_CLASS)
...
static TritonPluginResult initPlugin = TritonExtLoadPass(
    TOSTRING(TRITON_EXT_NAME), 
    TRITON_EXT_PASS_REGISTER_FUNC, 
