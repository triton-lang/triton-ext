#!/usr/bin/env python3
"""
This script retrieves the LLVM commit hash used by Triton. By default, it will
retrieve the version pinned in Triton's `main` branch on GitHub. But, if passed
a single argument--`<triton-rev>`--it will retrieve the LLVM commit hash for
that specific revision (i.e.,
